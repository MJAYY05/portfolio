    ...
    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {CERTS.map((cert) => (
        <ImageLightbox
          ...
          width={cert.width}
          height={cert.height}
          triggerClassName="group flex flex-col overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02] text-left transition-colors duration-300 hover:border-white/30"
        >
